# Evolution Proposal: Capture the user's request that signal alerts also show the actual option contract price and trade duration, not just spot-based Entry/Stop/Target.

- Proposal-ID: evo-2026-08-18-alert-option-price-duration
- Status: approved
- Signature: alert-option-price-duration
- Created-At: 2026-08-18 12:44
- Last-Seen-At: 2026-08-18 12:44
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- Capture the user's request that signal alerts also show the actual option contract price and trade duration, not just spot-based Entry/Stop/Target.
...
- **Signal alerts must also show the option contract price + duration**: the Entry/Stop/Target above are spot-based; every buy/sell alert must additionally show the actual option contract premium (entry/stop on the option) and the trade duration/expiry, so the user knows exactly which contract and price to trade. (Requested 2026-08-18.)
...
## User Approval
- Approve: 批准 evo-2026-08-18-alert-option-price-duration
- Reject: 拒绝 evo-2026-08-18-alert-option-price-duration
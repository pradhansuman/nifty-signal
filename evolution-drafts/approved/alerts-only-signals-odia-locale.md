# Evolution Proposal: Captures two durable user preferences: only buy/sell signal alerts are wanted (no other alert types), and the dashboard locale should be Odia.

- Proposal-ID: evo-2026-08-14-alerts-only-signals-odia-locale
- Status: approved
- Signature: alerts-only-signals-odia-locale
- Created-At: 2026-08-14 16:50
- Last-Seen-At: 2026-08-14 16:50
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- Captures two durable user preferences: only buy/sell signal alerts are wanted (no other alert types), and the dashboard locale should be Odia.
...
## User Approval
- Approve: 批准 evo-2026-08-14-alerts-only-signals-odia-locale
- Reject: 拒绝 evo-2026-08-14-alerts-only-signals-odia-locale
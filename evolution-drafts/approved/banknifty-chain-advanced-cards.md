# Evolution Proposal: Record the dashboard layout rule: the Bank Nifty option chain goes in the Advanced cards section, and the Position Sizing and Stop Loss cards are removed, so future dashboard edits keep this structure.

- Proposal-ID: evo-2026-08-14-banknifty-chain-advanced-cards
- Status: approved
- Signature: banknifty-chain-advanced-cards
- Created-At: 2026-08-14 22:54
- Last-Seen-At: 2026-08-14 22:54
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- Record the dashboard layout rule: the Bank Nifty option chain goes in the Advanced cards section, and the Position Sizing and Stop Loss cards are removed, so future dashboard edits keep this structure.
...
- The option chain on the dashboard main page is **Nifty's** (always visible, NOT collapsed); the **Bank Nifty** option chain lives inside a **collapsible** section (tap to expand). (Approved 2026-08-14.)
...
## User Approval
- Approve: 批准 evo-2026-08-14-banknifty-chain-advanced-cards
- Reject: 拒绝 evo-2026-08-14-banknifty-chain-advanced-cards
## Audit Note (2026-08-14 22:55)
- Applied to MEMORY.md by user approval ("批准 evo-2026-08-14-banknifty-chain-advanced-cards").
- Also trimmed the prior BNF-chain bullet to avoid duplication (BNF chain placement now governed by this rule).

# Evolution Proposal: Record that the Bitcoin arm of the trading tool now sources data from Delta Exchange (delta.exchange, India), so future BTC work targets the right data source.

- Proposal-ID: evo-2026-08-14-btc-delta-exchange-source
- Status: approved
- Signature: btc-delta-exchange-source
- Created-At: 2026-08-14 16:10
- Last-Seen-At: 2026-08-14 16:10
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- Record that the Bitcoin arm of the trading tool now sources data from Delta Exchange (delta.exchange, India), so future BTC work targets the right data source.
...
## User Approval
- Approve: 批准 evo-2026-08-14-btc-delta-exchange-source
- Reject: 拒绝 evo-2026-08-14-btc-delta-exchange-source
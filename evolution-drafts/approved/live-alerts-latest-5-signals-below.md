# Evolution Proposal: Capture the layout rule that Live Alerts keeps only the latest 5 alerts and the Intraday Signals card sits directly below it.

- Proposal-ID: evo-2026-08-18-live-alerts-latest-5-signals-below
- Status: approved
- Signature: live-alerts-latest-5-signals-below
- Created-At: 2026-08-18 13:23
- Last-Seen-At: 2026-08-18 13:23
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- Capture the layout rule that Live Alerts keeps only the latest 5 alerts and the Intraday Signals card sits directly below it.
...
- **Live Alerts capped at latest 5 + Intraday Signals directly below**: the Live Alerts section keeps only the latest 5 alerts, and the 📊 Intraday Signals card sits directly below the Live Alerts section. (Requested 2026-08-18.)
...
## User Approval
- Approve: 批准 evo-2026-08-18-live-alerts-latest-5-signals-below
- Reject: 拒绝 evo-2026-08-18-live-alerts-latest-5-signals-below
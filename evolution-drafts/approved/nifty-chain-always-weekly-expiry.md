# Evolution Proposal: Capture the user's rule that the Nifty option chain must always display the weekly expiry and roll to the next week once the current week's expiry passes.

- Proposal-ID: evo-2026-08-18-nifty-chain-always-weekly-expiry
- Status: approved
- Signature: nifty-chain-always-weekly-expiry
- Created-At: 2026-08-18 15:31
- Last-Seen-At: 2026-08-18 15:31
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- Capture the user's rule that the Nifty option chain must always display the weekly expiry and roll to the next week once the current week's expiry passes.
...
## User Approval
- Approve: 批准 evo-2026-08-18-nifty-chain-always-weekly-expiry
- Reject: 拒绝 evo-2026-08-18-nifty-chain-always-weekly-expiry
# Evolution Proposal: Record the dashboard layout rule: the option chain on the main page is Nifty's (not Bank Nifty's) and it must be collapsible, so future dashboard edits keep this placement.

- Proposal-ID: evo-2026-08-14-nifty-chain-collapsible
- Status: approved
- Signature: nifty-chain-collapsible
- Created-At: 2026-08-14 22:46
- Last-Seen-At: 2026-08-14 22:46
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- Record the dashboard layout rule: the option chain on the main page is Nifty's (not Bank Nifty's) and it must be collapsible, so future dashboard edits keep this placement.
...
- The option chain shown in the main page is **Nifty's** (not Bank Nifty's) and it is rendered as a **collapsible** section. (Approved 2026-08-14.)
...
## User Approval
- Approve: 批准 evo-2026-08-14-nifty-chain-collapsible
- Reject: 拒绝 evo-2026-08-14-nifty-chain-collapsible
## Audit Note (2026-08-14 22:47)
- Applied to MEMORY.md by user approval ("批准 evo-2026-08-14-nifty-chain-collapsible").
- Wording calibrated to actual implementation: NIFTY chain on main page (always visible); BANK NIFTY chain collapsible.

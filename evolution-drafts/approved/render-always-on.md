# Evolution Proposal: User wants the trading server to run as long as the laptop is working, with Render always on in the cloud as the permanent instance.

- Proposal-ID: evo-2026-08-13-render-always-on
- Status: approved
- Signature: render-always-on
- Created-At: 2026-08-13 13:15
- Last-Seen-At: 2026-08-13 13:15
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- User wants the trading server to run as long as the laptop is working, with Render always on in the cloud as the permanent instance.
...
- Uptime preference (approved 2026-08-13): the server/dashboard should run as long as the laptop is working, and Render should be **always on** in the cloud as the permanent instance (like a cloud service, not a temporary tunnel).
...
## User Approval
- Approve: 批准 evo-2026-08-13-render-always-on
- Reject: 拒绝 evo-2026-08-13-render-always-on
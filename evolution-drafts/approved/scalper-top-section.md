# Evolution Proposal: User asked to put the Nifty Scalper section at the top of the dashboard — a durable layout preference to record so future dashboard edits keep it there.

- Proposal-ID: evo-2026-08-14-scalper-top-section
- Status: approved
- Signature: scalper-top-section
- Created-At: 2026-08-14 11:12
- Last-Seen-At: 2026-08-14 11:12
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- User asked to put the Nifty Scalper section at the top of the dashboard — a durable layout preference to record so future dashboard edits keep it there.
...
- The ⚡ **NIFTY SCALPER** section sits at the **top** of the dashboard, above everything else. (Approved 2026-08-14.)
...
## User Approval
- Approve: 批准 evo-2026-08-14-scalper-top-section
- Reject: 拒绝 evo-2026-08-14-scalper-top-section

## Audit Note
- 2026-08-14 11:12 IST: Approved by user (批准). MEMORY.md updated — added the ⚡ NIFTY SCALPER top-of-dashboard layout rule under Trading Dashboard Preferences.
# Evolution Proposal: User confirmed Render free tier is unreliable and asked for local alerting too — MEMORY.md's "one host only" rule is replaced by Render-primary + Mac-failover (auto-probe, no duplicates, no missed alerts).

- Proposal-ID: evo-2026-08-14-telegram-failover
- Status: approved
- Signature: telegram-failover
- Created-At: 2026-08-14 10:22
- Last-Seen-At: 2026-08-14 10:22
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- User confirmed Render free tier is unreliable and asked for local alerting too — MEMORY.md's "one host only" rule is replaced by Render-primary + Mac-failover (auto-probe, no duplicates, no missed alerts).
...
## User Approval
- Approve: 批准 evo-2026-08-14-telegram-failover
- Reject: 拒绝 evo-2026-08-14-telegram-failover
# Evolution Proposal: User asked for unit testing on the trading system; the suite now exists in tests/ and future changes should keep it green — recording the run command and coverage keeps this durable workflow.

- Proposal-ID: evo-2026-08-14-unit-test-suite
- Status: approved
- Signature: unit-test-suite
- Created-At: 2026-08-14 11:47
- Last-Seen-At: 2026-08-14 11:47
- Target-File: MEMORY.md
- Trigger-Type: preference
- Confidence: medium

## Why This Matters
- User asked for unit testing on the trading system; the suite now exists in tests/ and future changes should keep it green — recording the run command and coverage keeps this durable workflow.
...
## User Approval
- Approve: 批准 evo-2026-08-14-unit-test-suite
- Reject: 拒绝 evo-2026-08-14-unit-test-suite

## Audit Note
- 2026-08-14 11:47 IST: Approved by user (批准). MEMORY.md updated — added the Unit Tests (2026-08-14) section with run-before-shipping command.